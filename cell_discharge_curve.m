function [ ...
    ...
    cell_discharge_curve(the_time_curve_file_name, time_curve_file_names)
...
mean_internal_resistance = mean(the_internal_resistance);
...
plot([ ...
    ...
    the_charge_discharged_from_cell(end)], ...
    [mean_internal_resistance, mean_internal_resistance]);
...
figure;
plot(the_charge_discharged_from_cell, the_cell_voltage);
title('Test Li-Ion 06');
xlabel('Charge Discharged from Cell (mC)');
